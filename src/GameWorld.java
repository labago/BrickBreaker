...
public class GameWorld extends World{
	...
	int play = 0;
	int switchh = 0;
	Color background2 = Color.green;
	Color background3 = Color.green;
	ArrayList<Rocket> rockets = new ArrayList<Rocket>();
	String powerUp = "";
	ArrayList<Laser> lasers = new ArrayList<Laser>();
	ArrayList<PowerUp> powerUps = new ArrayList<PowerUp>();
	int laserCount = 0;
	public GameWorld(Color background, Padel padel, Ball ball,
			ArrayList<Brick> bricks) {
	...
	public void initLevelFifteen(){
		
	}
	
	public void initLevelSixteen(){
		this.bricks.add(new Brick(Color.pink, new Posn(230 + (GameWorld.BRICK_WIDTH * 4), 630 - (GameWorld.BRICK_HIEGHT * -1)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(230 + (GameWorld.BRICK_WIDTH * 3), 630 - (GameWorld.BRICK_HIEGHT * 0)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(230 + (GameWorld.BRICK_WIDTH * 2), 630 - (GameWorld.BRICK_HIEGHT * 1)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(230 + (GameWorld.BRICK_WIDTH * 1), 630 - (GameWorld.BRICK_HIEGHT * 2)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(260 + (GameWorld.BRICK_WIDTH * 0), 630 - (GameWorld.BRICK_HIEGHT * 3)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(310 + (GameWorld.BRICK_WIDTH * -1), 630 - (GameWorld.BRICK_HIEGHT * 4)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(370 + (GameWorld.BRICK_WIDTH * -2), 630 - (GameWorld.BRICK_HIEGHT * 5)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(360 + (GameWorld.BRICK_WIDTH * -2), 630 - (GameWorld.BRICK_HIEGHT * 6)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(350 + (GameWorld.BRICK_WIDTH * -2), 630 - (GameWorld.BRICK_HIEGHT * 7)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(360 + (GameWorld.BRICK_WIDTH * -2), 630 - (GameWorld.BRICK_HIEGHT * 8)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(370 + (GameWorld.BRICK_WIDTH * -2), 630 - (GameWorld.BRICK_HIEGHT * 9)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(390 + (GameWorld.BRICK_WIDTH * -2), 630 - (GameWorld.BRICK_HIEGHT * 10)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(410 + (GameWorld.BRICK_WIDTH * -2), 630 - (GameWorld.BRICK_HIEGHT * 11)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(410 + (GameWorld.BRICK_WIDTH * -1), 630 - (GameWorld.BRICK_HIEGHT * 12)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(410 + (GameWorld.BRICK_WIDTH * 0), 630 - (GameWorld.BRICK_HIEGHT * 11)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(410 + (GameWorld.BRICK_WIDTH * 1), 630 - (GameWorld.BRICK_HIEGHT * 10)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(230 + (GameWorld.BRICK_WIDTH * 4), 630 - (GameWorld.BRICK_HIEGHT * 9)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(230 + (GameWorld.BRICK_WIDTH * 5), 630 - (GameWorld.BRICK_HIEGHT * 0)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(230 + (GameWorld.BRICK_WIDTH * 6), 630 - (GameWorld.BRICK_HIEGHT * 1)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(310 + (GameWorld.BRICK_WIDTH * 6), 630 - (GameWorld.BRICK_HIEGHT * 2)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(280 + (GameWorld.BRICK_WIDTH * 7), 630 - (GameWorld.BRICK_HIEGHT * 3)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(310 + (GameWorld.BRICK_WIDTH * 7), 630 - (GameWorld.BRICK_HIEGHT * 4)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(330 + (GameWorld.BRICK_WIDTH * 7), 630 - (GameWorld.BRICK_HIEGHT * 5)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(340 + (GameWorld.BRICK_WIDTH * 7), 630 - (GameWorld.BRICK_HIEGHT * 6)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(350 + (GameWorld.BRICK_WIDTH * 7), 630 - (GameWorld.BRICK_HIEGHT * 7)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(340 + (GameWorld.BRICK_WIDTH * 7), 630 - (GameWorld.BRICK_HIEGHT * 8)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(330 + (GameWorld.BRICK_WIDTH * 7), 630 - (GameWorld.BRICK_HIEGHT * 9)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(320 + (GameWorld.BRICK_WIDTH * 7), 630 - (GameWorld.BRICK_HIEGHT * 10)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(300 + (GameWorld.BRICK_WIDTH * 7), 630 - (GameWorld.BRICK_HIEGHT * 11)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(300 + (GameWorld.BRICK_WIDTH * 6), 630 - (GameWorld.BRICK_HIEGHT * 12)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(300 + (GameWorld.BRICK_WIDTH * 5), 630 - (GameWorld.BRICK_HIEGHT * 11)), 10));
		this.bricks.add(new Brick(Color.pink, new Posn(300 + (GameWorld.BRICK_WIDTH * 4), 630 - (GameWorld.BRICK_HIEGHT * 10)), 10));
		
		//J
		this.bricks.add(new Brick(Color.gray, new Posn(220 + (GameWorld.BRICK_WIDTH * 2), 620 - (GameWorld.BRICK_HIEGHT * 4)), 999999999));
		this.bricks.add(new Brick(Color.gray, new Posn(220 + (GameWorld.BRICK_WIDTH * 1), 620 - (GameWorld.BRICK_HIEGHT * 5)), 999999999));
		this.bricks.add(new Brick(Color.gray, new Posn(220 + (GameWorld.BRICK_WIDTH * 3), 620 - (GameWorld.BRICK_HIEGHT * 5)), 999999999));
		this.bricks.add(new Brick(Color.gray, new Posn(220 + (GameWorld.BRICK_WIDTH * 3), 620 - (GameWorld.BRICK_HIEGHT * 6)), 999999999));
		this.bricks.add(new Brick(Color.gray, new Posn(220 + (GameWorld.BRICK_WIDTH * 3), 620 - (GameWorld.BRICK_HIEGHT * 7)), 999999999));
		// M
		this.bricks.add(new Brick(Color.gray, new Posn(240 + (GameWorld.BRICK_WIDTH * 4), 620 - (GameWorld.BRICK_HIEGHT * 4)), 999999999));
		this.bricks.add(new Brick(Color.gray, new Posn(250 + (GameWorld.BRICK_WIDTH * 4), 620 - (GameWorld.BRICK_HIEGHT * 5)), 999999999));
		this.bricks.add(new Brick(Color.gray, new Posn(270 + (GameWorld.BRICK_WIDTH * 4), 620 - (GameWorld.BRICK_HIEGHT * 6)), 999999999));
		this.bricks.add(new Brick(Color.gray, new Posn(290 + (GameWorld.BRICK_WIDTH * 4), 620 - (GameWorld.BRICK_HIEGHT * 7)), 999999999));
		this.bricks.add(new Brick(Color.gray, new Posn(270 + (GameWorld.BRICK_WIDTH * 5), 620 - (GameWorld.BRICK_HIEGHT * 6)), 999999999));
		this.bricks.add(new Brick(Color.gray, new Posn(270 + (GameWorld.BRICK_WIDTH * 5), 620 - (GameWorld.BRICK_HIEGHT * 5)), 999999999));
		this.bricks.add(new Brick(Color.gray, new Posn(270 + (GameWorld.BRICK_WIDTH * 5), 620 - (GameWorld.BRICK_HIEGHT * 4)), 999999999));
		this.bricks.add(new Brick(Color.gray, new Posn(330 + (GameWorld.BRICK_WIDTH * 5), 620 - (GameWorld.BRICK_HIEGHT * 7)), 999999999));
		this.bricks.add(new Brick(Color.gray, new Posn(350 + (GameWorld.BRICK_WIDTH * 5), 620 - (GameWorld.BRICK_HIEGHT * 6)), 999999999));
		this.bricks.add(new Brick(Color.gray, new Posn(370 + (GameWorld.BRICK_WIDTH * 5), 620 - (GameWorld.BRICK_HIEGHT * 5)), 999999999));
		this.bricks.add(new Brick(Color.gray, new Posn(380 + (GameWorld.BRICK_WIDTH * 5), 620 - (GameWorld.BRICK_HIEGHT * 4)), 999999999));
	...
	public void checkHits(){
		for(int i = 0; i < this.bricks.size(); i++){
			...
			if (this.bricks.get(i).hits == 8){
				this.bricks.get(i).color = Color.orange;
			}
		}
	}
	...
	public void reset(){
		...
		//this.lives = this.lives + 1;  //activate for an easier game
		this.balls.clear();
		this.balls.add(new Ball(Color.black, new Posn(570,860), GameWorld.BALL_RADIUS_START, "upLeftLeft"));
		this.padel = new Padel(Color.black, new Posn(510, 900 - GameWorld.PADEL_HIEGHT));
		this.holdBall = 1;
	...
	public void onTick() {
		...
		else { this.background2 = Color.green;
			   this.background3 = Color.green;
			}	
		this.moveLasers();
		this.moveRocket();
		...
		if(this.noMoreValidBricks() && this.level == 1){
			...
			this.reset();
			this.initLevelSixteen();
		}
		else if(this.noMoreValidBricks() && this.level == 15){
			this.reset();
			this.level = 1;
			this.initLevelOne();
		}
	...
	public void draw() {
		...
		*/
		...
		this.theCanvas.drawString(new Posn(10, 880), "By: Jonathan Lane");
	}
	...
	public static void main(String args[]){
		...
		GameWorld world = new GameWorld(Color.cyan, new Padel(Color.black, new Posn(510, 900 - GameWorld.PADEL_HIEGHT)), 
				new Ball(Color.black, new Posn(570,860), GameWorld.BALL_RADIUS_START, "upLeftLeft"), new ArrayList<Brick>());
		
		world.initLevelOne();
		
		world.bigBang(1200, 900, .015);
